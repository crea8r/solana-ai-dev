...
import { ChevronLeft, Menu, FileText, Database, Code, Zap, AlertTriangle, Coins, Shield, Download } from 'lucide-react';
...
const DocPage: React.FC = () => {
  ...
  const formatContent = (content: string) => {
    ...
    formattedContent = formattedContent.replace(/\*\*(.*?)\*\*/g, '<div class="file-item"><span class="font-semibold">$1</span>');
    ...
    formattedContent = formattedContent.replace(/project\/\n/g, 'project/<br/>')
      .replace(/- /g, '<br/>&nbsp;&nbsp;')
      .replace(/: /g, '&nbsp;&nbsp;&nbsp;&nbsp;')
      ...
      .replace(/mint_tokens\.rs/g, '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;mint_tokens.rs')
      .replace(/mod\.rs/g, '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;mod.rs')
      .replace(/tests/g, '&nbsp;&nbsp;tests')
      .replace(/token_management\.ts/g, '&nbsp;&nbsp;&nbsp;&nbsp;token_management.ts')
