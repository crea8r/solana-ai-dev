...
The SDK should cover all instructions and function to get all accounts with filters.\n`;
  ...
  Return me the project structure as a json object with an array of object, each object has a key 'name' and 'children' (array of object)
  The json should remove every unneccessary space, newline so it can be easily parse by browser JSON.
  \n`;
  return (
